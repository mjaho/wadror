...
describe "beerlist page" do
  ...
  it "has the correct alphabetic order", js: true do
    visit beerlist_path
  ...
  it "sorts the list based on style when style is clicked", js:true do
    visit beerlist_path
    find('#style').click
    #save_and_open_page
  ...
  it "sorts the list based on brewery when brewery is clicked", js:true do
    visit beerlist_path
    find('#brewery').click
    #save_and_open_page
